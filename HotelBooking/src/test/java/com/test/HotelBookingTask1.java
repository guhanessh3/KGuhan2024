...
public class HotelBookingTask1 {
	public static void main(String[] args) throws InterruptedException {
		...
		s6.selectByVisibleText("Debit Card");
		WebElement cardname = driver.findElement(By.id("card_type"));
		Select s7 = new Select(cardname);
	    ...
	    WebElement hotelname = driver.findElement(By.xpath("//strong[text()='Hilton']"));
	    System.out.println(hotelname.getText());Thread.sleep(1000);
