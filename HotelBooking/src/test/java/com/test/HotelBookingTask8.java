...
public class HotelBookingTask8 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement nameascending = driver.findElement(By.xpath("//label[@for='value_nasc']"));
		nameascending.click();
		Thread.sleep(3000);
		...
		if (b) {
			System.out.println("Hotel names are in ascending order");
		}else {
				System.out.println("Hotel names are not in ascending order");
