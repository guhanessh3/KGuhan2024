...
public class FHotelBookingYTask6 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement btnlowtohigh = driver.findElement(By.xpath("//label[text()='Price low to high']"));
		btnlowtohigh.click();
		Thread.sleep(3000);
		...
		if (b) {
			System.out.println("Prices are in assending order");
		}else {
